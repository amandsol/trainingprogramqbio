...
par(mfrow = c(1, 1))
#residual does not form a normal distribution
...
#creating a new data frame with combinations of mass with species
...
#media 2 has a positive effect
#media 3 and 4 have a negative effect
